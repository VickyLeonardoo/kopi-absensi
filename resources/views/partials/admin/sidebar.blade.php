{{-- <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #f4f6f9">
    ...
    <div class="sidebar">
        ...
        <div class="mt-3 pb-3 mb-3 d-flex">
            <div>
                <p style="font-size: 28px"><b>Penkopi To Go</b></p>
            </div>
        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item menu-open">
                    <a href="#"
                        class="nav-link {{ Route::is('absensi.*','izin.*') ? 'active' : '' }}"
                        style="color: black">
                        <i class="fa-solid fa-database"></i>
                        <p>
                            Absensi
                ...
                class="nav-item">
                <a href="/owner/admin"
                    class="nav-link {{ Route::is('owner*') ? 'active' : '' }}"
                    style="color: black">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item menu-open">
                    <a href="#"
                        class="nav-link {{ Route::is('outlet.*','shift.*','karyawan.*','keterangan.*') ? 'active' : '' }}"
                        style="color: black">
                        <i class="fa-solid fa-database"></i>
                        <p>
                            Master Data
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="/admin/master-data/keterangan-izin"
                                class="nav-link {{ Route::is('keterangan.*') ? 'active' : '' }}"
                                style="color: black">
                ...
                <li class="nav-item menu-open" style="text-align: center;">
                    <a href="" class="btn"
